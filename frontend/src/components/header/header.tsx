...
import { useSchuljahr } from "../../services/schuljahr-context.tsx"; // <== wichtig
        ...
        <header style={{ gridArea: "header" }}>
            ...
            <div className={"header-right"}>
                ...
                <select
                    id="schuljahr"
                    value={schuljahr}
                    onChange={(e) => setSchuljahr((e.target as HTMLSelectElement).value)}
                >
                    {alleSchuljahre.map((sj) => (
                        <option key={sj.id} value={sj.anzeigeform}>
                            {sj.anzeigeform}
                        </option>
                    ))}
                </select>
