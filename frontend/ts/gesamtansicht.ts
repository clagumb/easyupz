...
export async function init() {
    ...
    try {
        ...
        const template = document.getElementById("lehrer-zeile") as HTMLTemplateElement;
        ...
        for (const lehrer of lehrerListe) {
            ...
            (clone.querySelector(".vorname") as HTMLElement).textContent = lehrer.vorname;
            (clone.querySelector(".nachname") as HTMLElement).textContent = lehrer.nachname;
